angular.module("omniConfig")
	...
	"WALLET":{
		...
		"SEND":{
			...
			"LOWFEE":"Your 'From Address' does not have enough BTC to complete this transaction. Please send at least {{ topupAmount }} BTC to cover the estimate Total transaction cost.",
