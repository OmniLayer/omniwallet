angular.module("omniConfig")
	...
	"MFA":{
		...
		"GENERROR2":"If this error continues to happen please notify the Omniwallet team.",
	...
	"ABOUT":{
		...
		"OMNI":{
			...
			"TOKEN":{
				"TITLE":"Omnis",
				"FIRST" : "Omni Tokens (symbol OMNI) are digital tokens that are necessary for the use of some features of the Omni Protocol. The total number of OMNIs in existence is 619,478.6 and no more Omni Tokens will ever be created. Additionally, OMNIs can not be mined into existence. The 619,478.6 OMNI were generated as a result of a public fundraiser in the style of Kickstarter.com."
			},
		...
		"OMNIWALLET":{
			...
			"MULTICURRENCY" : {
				...
				"BUILT" : "Omniwallet comes with a pre-built support for Bitcoin, Omni Token and Test Omni Token",
	...
	"MODALS":{
		...
		"LOGIN":{
			...
			"UUIDEMAIL":"Please login with your Wallet ID, not Email.",
			"UUIDEMAIL2":"For more info please see this article on the "
		}, 
		"CONFIRM":{
		...
		"IMPORT":{
			...
			"WATCH":{
				"TITLE":"Import a Watch Only BTC/Omni Layer Address",
				"ADDRESS":"Enter Address",
				"DESC":"Watch Only"
			},
			"ENCRYPTED":{
				"TITLE":"Import an Encrypted BTC/Omni Layer Private Key",
				"KEY":"Enter Encrypted Key (Send/Receive)",
				"KEYHOLDER":"enter your encrypted private key",
				"PASSHOLDER":"enter your passphrase"
			},
			"PRIVATE":{
				"TITLE":"Import a BTC/Omni Layer Private Key",
				"ENTER":"Enter",
				"KEY":"Private Key",
			...
			"WALLET":{
				...
				"INVALID":"Must be a valid Omniwallet backup file"
			}
		},
		"EXPORT":{
			"TITLE":"Export Wallet",
	...
	"WALLET":{
		...
		"ADDRESSES":{
			...
			"WATCHONLY":"Track the balance of an address in another wallet. Can NOT BE Activated/Unlocked by sending funds anywhere. To enable spending you need to import the private key."
		},
		"SEND":{
			"TITLE":"Send",
	...
	"EXCHANGE":{
		"TRADE":{
			...
			"PRICE":"BTC Per Token",
			"AMOUNT":"Available",
			"COST":"Buy All Cost (BTC)",
			"FEE":"Minimum Miner Fee to Accept",
			"FEESHORT":"Fee",
                        "FEEDESC":"The 'Minimum Miners Fee' required for an accept transaction to be valid",
		...
		"SALE":{
			...
			"REMAININGDESC":"The Amount remaining for sale that is available to be accepted by new offers."
		},
		"BUY":{
			"TITLE":"Accept Offer",
