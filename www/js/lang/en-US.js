angular.module("omniConfig")
	...
	"WALLET":{
		...
		"ADDRESSES":{
			...
			"WATCHONLY":"Track the balance of an address in another wallet. Can NOT BE Acitvate/Unlocked by sending funds anywhere. To enable spending you need to import the private key."
		},
		"SEND":{
			"TITLE":"Send",
