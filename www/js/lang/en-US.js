angular.module("omniConfig")
	...
	"ABOUT":{
		...
		"OMNI":{
			...
			"TOKEN":{
				"TITLE":"Omnis",
				"FIRST" : "Omni Tokens (symbol OMN) are digital tokens that are necessary for the use of some features of the Omni Protocol. The total number of OMNs in existence is 619,478.6 and no more Omni Tokens will ever be created. Additionally, OMNs can not be mined into existence. The 619,478.6 OMN were generated as a result of a public fundraiser in the style of Kickstarter.com."
			},
