angular.module("omniConfig")
	...
	"OMNIDEX" : {
		...
		"ORDERBOOK" : {
			...
			"EMPTY" : "No offers",
			"AMOUNTTOOLTIP" : "The Sum of the Amount Available for all orders at this price point",
			"TOTALTOOLTIP" : "The Aggregate Sum of the Total Amount Available in all orders at this price or better",
			"ID" : "Offer ID"
		},
		"SALE" : {
