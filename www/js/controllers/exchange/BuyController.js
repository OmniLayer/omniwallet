angular.module("omniControllers")
  .controller("ExchangeBuyController",["$modal", "$scope", "$http", "$q", "Wallet", "walletTransactionService", "Account",

function ExchangeBuyController($modal, $scope, $http, $q, Wallet, walletTransactionService, Account) {
