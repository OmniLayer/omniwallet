angular.module("omniFactories")
    .factory("TransactionManager", ["$q", "userService", "TransactionGenerator", function TransactionManagerFactory($q, userService, TransactionGenerator) {
        ...
        var TransactionManager = function(txType) {
            ...
            self.prepareTransaction = function(unsignedTransactionHex, sourceScript) {
                var = ; /* Backwards compatibility for mastercoin-tools send API */
            ...
            self.pushTransaction = function(txData, signOffline) {
            ...
            self.broadcastTransaction = function(signedHex, from) {
                var deferred = $q.defer();
