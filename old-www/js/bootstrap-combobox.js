  ...
  * ================================ */
  ...
  , parse: function () {
      ...
      if (selected) {
        ...
        this.$container.addClass('combobox-selected1');
        this.selected = true;
      }
      return source;
    }
  ...
  , toggle: function () {
    //if (this.$container.hasClass('combobox-selected1')) {
    //  this.clearTarget();
    //  this.triggerChange();
    // // this.clearElement();
    //} else {
  ...
  , clearTarget: function () {
    this.$source.val('');
    this.$target.val('');
    this.$container.removeClass('combobox-selected1');
    this.selected = false;
  }
  ...
  , blur: function (e) {
    //  console.log(this.options);
      ...
      //provera da li ovaj tekst postoji u options, ako ne postoji dodam i selektujem ga
      //ako postoji samo selektujem
      var menu = that.$menu;
    //  console.log(menu);
